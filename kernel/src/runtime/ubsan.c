...
[[gnu::used, noreturn]] void __ubsan_handle_pointer_overflow(struct tu_pointer_overflow_data* data) {
...
[[gnu::used, noreturn]] void __ubsan_handle_pointer_overflow_abort(struct tu_pointer_overflow_data* data) {
